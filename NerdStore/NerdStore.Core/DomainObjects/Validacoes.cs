...
namespace NerdStore.Core.DomainObjects
{
    public class Validacoes
    {
        ...
        public static void ValidarSeFalso(bool boolValor, int minimo, string mensagem)
        {
            if (!boolValor)
            {
                throw new DomainException(mensagem);
        ...
        public static void ValidarSeVerdadeiro(bool boolValor, int minimo, string mensagem)
        {
            if (boolValor)
            {
                throw new DomainException(mensagem);
